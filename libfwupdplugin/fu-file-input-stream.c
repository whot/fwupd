 ...
 *
 * Opens a #GFile for reading and returns a #FuFileInputStream.
 *
 ...
 **/
FuFileInputStream *
fu_file_input_stream_from_file(GFile *file, /* nocheck:blocked */
 ...
 **/
GFileInfo *
fu_file_input_stream_query_info(FuFileInputStream *stream, /* nocheck:blocked */
				const gchar *attributes,
				GCancellable *cancellable,
				GError **error)
{
	g_return_val_if_fail(G_IS_FILE_INPUT_STREAM(stream), NULL); /* nocheck:blocked */
