...
macro_rules! crate_root {
    () => {
        ...
        // Meson: inline replacement for build.rs-generated private.rs.
        // build.rs generates:
        //   pub mod __private<PATCH> { pub use crate::private::*; }
        //   use serde_core::__private<PATCH> as serde_core_private;
        #[doc(hidden)]
